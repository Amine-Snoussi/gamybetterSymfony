 ...
 */
final class Version20220423203412 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipe ADD description_equipe VARCHAR(255) DEFAULT NULL, CHANGE nom nom VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipe DROP description_equipe, CHANGE nom nom VARCHAR(255) NOT NULL');
    }
}
