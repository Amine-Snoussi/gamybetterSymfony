 ...
 */
final class Version20220504031320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produit (id_produit INT AUTO_INCREMENT NOT NULL, image VARCHAR(255) NOT NULL, nom_produit VARCHAR(50) NOT NULL, description VARCHAR(200) NOT NULL, categorie VARCHAR(50) NOT NULL, game VARCHAR(50) NOT NULL, quantite_stock INT NOT NULL, prix_unitair NUMERIC(6, 3) NOT NULL, discount INT NOT NULL, stars INT NOT NULL, PRIMARY KEY(id_produit)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
