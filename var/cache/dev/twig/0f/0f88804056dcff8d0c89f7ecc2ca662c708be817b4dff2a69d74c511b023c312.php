...
class __TwigTemplate_b24e4d90e29a724969d1b0be2cb86df021cc1d65c2842a43704e573996487a39 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        <tr>
            ...
            <td>";
        // line 15
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["cour"]) || array_key_exists("cour", $context) ? $context["cour"] : (function () { throw new RuntimeError('Variable "cour" does not exist.', 15, $this->source); })()), "id", [], "any", false, false, false, 15), "html", null, true);
        echo "</td>
        </tr>
        <tr>
            <th>Categorie</th>
        ...
        <tr>
            ...
            <td><img src=\"";
        // line 31
        echo twig_escape_filter($this->env, ("/uploads/" . twig_get_attribute($this->env, $this->source, (isset($context["cour"]) || array_key_exists("cour", $context) ? $context["cour"] : (function () { throw new RuntimeError('Variable "cour" does not exist.', 31, $this->source); })()), "fileName", [], "any", false, false, false, 31)), "html", null, true);
        echo "\" alt=\"\"></td>
        </tr>
        </tbody>
    </table>
...
";
    ...
    {
        return array (  141 => 36,  133 => 31,  126 => 27,  119 => 23,  112 => 19,  105 => 15,  95 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <table class=\"table\">
        ...
        <tr>
            <th>Image</th>
            <td><img src=\"{{ '/uploads/' ~ cour.fileName }}\" alt=\"\"></td>
        </tr>
        </tbody>
    </table>
